...
class TaskAlignedAssigner(nn.Module):
    ...
    def forward(self,
        ...
        target_labels_lst, target_bboxes_lst, target_attrs_lst, target_scores_lst, fg_mask_lst = [], [], [], [], []
        ...
        for i in range(cycle):
            ...
            # Assigned target
            target_labels, target_bboxes, target_attrs, target_scores = self.get_targets(gt_labels_, gt_bboxes_, gt_attrs_, target_gt_idx, fg_mask)
            ...
            target_attrs_lst.append(target_attrs)
        ...
        target_attrs = torch.cat(target_attrs_lst, 0)
        target_scores = torch.cat(target_scores_lst, 0)
        fg_mask = torch.cat(fg_mask_lst, 0)

        return target_labels, target_bboxes, target_attrs, target_scores, fg_mask.bool()
    ...
    def get_targets(self,
        ...
        #   Assigned target attrs
        target_attrs = gt_attrs.reshape([-1, 40])[target_gt_idx]
        ...
        return target_labels, target_bboxes, target_attrs, target_scores
